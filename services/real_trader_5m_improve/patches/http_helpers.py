...
# Configurable timeout via environment variable (default: 15 seconds)
CLOB_HTTP_TIMEOUT = float(os.getenv("CLOB_HTTP_TIMEOUT", "15"))
_http_client = httpx.Client(http2=True, timeout=CLOB_HTTP_TIMEOUT)
